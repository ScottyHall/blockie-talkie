...
"""
Based on Bleak Example code from the bleak project
UART Service

An example showing how to write a simple program using the Nordic Semiconductor
(nRF) UART service.

Used for testing the bluetooth Blockie Talkie code

Can run on multiple platforms and separate system. Just ensure you are
connected to the device you are testing with through bluetooth
